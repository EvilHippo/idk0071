...
{
    // this.text = game.add.text(200, 250, 'LEADERBOARD', {font: "20px", fill: "#ffffff"});
    text2 = game.add.text(200, 270, '', {font: "20px", fill: "#ffffff"});
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            for(var i = 0; i < listLenght; i++)
                {   
                    console.log("username " + data[i].username + "score " + data[i].score);
                    usernames = game.add.text(200, y, "username | " + data[i].username, { font: "20px",fill: '#ffffff' });
                    text2 = game.add.text(300, y, "         score | " + data[i].score, { font: "20px",fill: '#ffffff' });
                    y = y + 18; 
                }
        }
    });
