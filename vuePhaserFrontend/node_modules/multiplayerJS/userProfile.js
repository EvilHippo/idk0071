            ...
            for(var i = 0; i < listLenght; i++)
                {
                    ...
                    var text = game.add.text(100, yCord, "username " + data[i].username, {font: "20px", fill: '#ffffff' });
                   var text2 = game.add.text(200, yCord, "score: " + data[i].score, { font: "20px",fill: '#ffffff' });
                    yCord = yCord + 12;
                }
        }
    });
