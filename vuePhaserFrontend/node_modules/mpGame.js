...
mpGame.prototype = {	
	...
	preload: function() {
        ...
        game.load.tilemap('level1', null, map, Phaser.Tilemap.TILED_JSON);
	...
	update: function () {
        ...
        hitPlatform2 = game.physics.arcade.collide(player2, layer);
        
        var jump = "false";
        var action = "none";
        // players[serverJson.id].body.onFloor()
        /*
        ...
        */
        ...
        if (cursors.up.isDown && ((player.body.onFloor() && hitPlatform ) || (player2.body.onFloor() && hitPlatform2)))
        {
            jump = "true";
        }
