...
function movePlayers(serverJson) {
    ...
    console.log("incoming ID: " + serverJson.id);
    /*
    ...
    */
    ...
    if(!checkForPlayer(serverJson.id)) {
        ...
        players[serverJson.id] = createPlayer();
    }
    */
    ...
    /*
    if (serverJson.jump == "true" && players[serverJson.id].body.touching.down && hitPlatform)
    {
        players[serverJson.id].body.velocity.y = -350;
    }
    */
...
mpGame.prototype = {	
    init: function(newEnemyName, newEnemyId, newMap) {
        console.log("init eName, eId, eMap: " + newEnemyName + " " + newEnemyId + " "+ newMap);
		enemyID = newEnemyId;
	...
	update: function () {
        ...
        hitPlatform2 = game.physics.arcade.collide(player2, platforms);
        if (cursors.up.isDown && ((player.body.touching.down && hitPlatform )|| (player2.body.touching.down && hitPlatform2)))
        {
            jump = "true";
        }
