    ...
    playerPassword = logInPassword.value;
        ...
        success: function(data)
        {
            ...
            if(data.success == false)
                {
                    this.logInError = game.add.text(100, 150, 'You entered wrong username or password.', {font: "15px Arial", fill: "#950010"});
                }
...
function waitGame() {
    ...
    // let the server know theres a new player
     $.ajax({
        ...
        data: "{'UID':" + playerId + ", 'registeredUser': {'username': " + document.cookie + "}}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
     });
